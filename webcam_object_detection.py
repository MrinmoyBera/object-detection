# -*- coding: utf-8 -*-
"""
Created on Tue Jul  9 16:26:14 2024
...
# Paths to the model weights and config files
weightsPath = "C:\\Users\\Mrinmoy Bera\\Downloads\\weight.pb"
configPath = "C:\\Users\\Mrinmoy Bera\\Downloads\\config.pbtxt"

def object_detector(weightsPath, configPath):
    # Load the pretrained model
    net = cv2.dnn.readNetFromTensorflow(weightsPath, configPath)

    cap = cv2.VideoCapture(0)  # Use 0 to capture video from the webcam
...
# Call the object detector function
object_detector(weightsPath, configPath)
